...
public interface RollupSeriesRestorer<T extends  Statistics> {
    RollupSeries<T> restore(InputStream is) throws StreamReadingException, IOException;
    RollupSeries<T> restore(Path checkpoint) throws StreamReadingException, IOException;
}
