...
- Prefer builders over writing multiple setters. E.g. instead var x = new MyObject; x.setFieldA(); x.setFieldB(). Use a
  builder - MyObject.builder().fieldA(A).fieldB(B) etc.
