...
public class PromQlRocksQueryProcessorTests {
  ...
  public static Stream<Arguments> timeTransformers() {
    Function<Long, String> toSeconds = PromQlRocksQueryProcessorTests::toDoubleSeconds;
    Function<Long, String> toDate = PromQlRocksQueryProcessorTests::toRfc3339Date;
