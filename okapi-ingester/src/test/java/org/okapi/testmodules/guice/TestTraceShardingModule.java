...
public class TestTraceShardingModule extends AbstractModule {
  private final WhoAmI whoAmI;
  private final List<Integer> assignedShards;
  private final Map<Long, Integer> blockShardMap;
  private final Map<String, Integer> streamShardMap;
  private final String remoteNodeId;

  public TestTraceShardingModule(
      WhoAmI whoAmI,
    ...
    this.streamShardMap = streamShardMap;
  ...
  protected void configure() {
    ...
    var fixedMapShardAssigner =
        new FixedMapShardAssigner<String>(blockShardMap, new HashMap<>(streamShardMap));
