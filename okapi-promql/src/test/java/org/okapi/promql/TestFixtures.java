...
public class TestFixtures {
  ...
  public static CommonMocks buildCommonMocks() {
    ...
    client.put("http_requests_counter", httpTags, t0, new MockStatistics(List.of(60f)));
    client.put("http_requests_counter", httpTags, t1, new MockStatistics(List.of(120f)));
    client.put("http_requests_counter", httpTags, t2, new MockStatistics(List.of(180f)));
    client.put("http_requests_counter", httpTags, t3, new MockStatistics(List.of(240f)));
    ...
    client.put("cpu_usage", cpuI1Tags, t0, new MockStatistics(List.of(10f)));
    client.put("cpu_usage", cpuI1Tags, t1, new MockStatistics(List.of(20f)));
    client.put("cpu_usage", cpuI1Tags, t2, new MockStatistics(List.of(30f)));
    client.put("cpu_usage", cpuI1Tags, t3, new MockStatistics(List.of(40f)));
    ...
    client.put("cpu_usage", cpuI2Tags, t0, new MockStatistics(List.of(40f)));
    client.put("cpu_usage", cpuI2Tags, t1, new MockStatistics(List.of(60f)));
    client.put("cpu_usage", cpuI2Tags, t2, new MockStatistics(List.of(80f)));
    client.put("cpu_usage", cpuI2Tags, t3, new MockStatistics(List.of(100f)));
    ...
    client.put("mem_usage", memI1Tags, t0, new MockStatistics(List.of(50f)));
    client.put("mem_usage", memI1Tags, t1, new MockStatistics(List.of(60f)));
    client.put("mem_usage", memI1Tags, t2, new MockStatistics(List.of(70f)));
    client.put("mem_usage", memI1Tags, t3, new MockStatistics(List.of(80f)));

    // pod_replicas per job (single series)
    var repTags = Map.of("job", "api");
    var replicas = new SeriesId("pod_replicas", new Labels(repTags));
    client.put("pod_replicas", repTags, t0, new MockStatistics(List.of(3f)));
    client.put("pod_replicas", repTags, t1, new MockStatistics(List.of(3f)));
    client.put("pod_replicas", repTags, t2, new MockStatistics(List.of(3f)));
    client.put("pod_replicas", repTags, t3, new MockStatistics(List.of(3f)));
